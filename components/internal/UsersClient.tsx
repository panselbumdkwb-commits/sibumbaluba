...
import { UserPlus, Shield, UserCheck, UserX, Loader2, Eye, EyeOff, Pencil } from 'lucide-react'
        ...
        <div className="bg-card border border-border rounded-xl p-6">
          ...
          <form onSubmit={handleCreate} className="grid sm:grid-cols-2 gap-4">
            <div>
              ...
              <input value={form.username} onChange={set('username')} placeholder="username_unik"
            ...
            <div>
              ...
              <input value={form.full_name} onChange={set('full_name')} placeholder="Nama Lengkap"
                className="w-full h-10 px-3 rounded-lg border border-input bg-background text-sm focus:outline-none focus:ring-2 focus:ring-primary" />
            </div>
            <div>
