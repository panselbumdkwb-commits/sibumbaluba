...
import { ArrowRight, BarChart3, FileText, Users, Shield, ChevronRight, TrendingUp } from 'lucide-react'
      ...
      <div className="container relative mx-auto px-4 py-16 lg:py-24">
        ...
        <div className="grid lg:grid-cols-[1fr_380px] gap-12 items-start">
          ...
          <div className="hidden lg:flex flex-col gap-4">
            ...
            <Link href="/login"
              className="flex items-center justify-between rounded-xl border border-primary/20 bg-primary/5 p-5 hover:bg-primary/10 hover:border-primary/30 transition-all group">
              <div>
                <div className="text-sm font-semibold text-foreground">Akses Internal</div>
                <div className="text-xs text-muted-foreground mt-0.5">Login untuk pengguna internal</div>
              </div>
